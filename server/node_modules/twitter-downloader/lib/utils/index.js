...
const _twitterapi = (id) => `https://api.twitter.com/1.1/statuses/show/${id}.json?tweet_mode=extended`;
...
const TwitterDL = (url) => new Promise(async (resolve, reject) => {
    ...
    (0, axios_1.default)(_twitterapi(id[1]), {
        method: "GET",
        headers: {
            Authorization: await getAuthorization(),
